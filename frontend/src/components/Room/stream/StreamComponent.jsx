...
function StreamComponent({user, handleNickNname, sessionId, camStatusChanged, micStatusChanged}){
    ...
    <div className="OT_widget-container" style={{}}>
        ...
        {user !== undefined &&
        user.getStreamManager() !== undefined ? (
        <div className="streamComponent" onMouseEnter={handleChangeControlBox} onMouseLeave={handleChangeControlBox}>
            <OvVideoComponent
            user={user}
